...
const CandidateSignup = () => {
  ...
  const fields = [
    { icon: User, type: "text" as const, placeholder: "Full Name", value: fullName, setter: setFullName, required: true },
    { icon: Mail, type: "email" as const, placeholder: "Email address", value: email, setter: setEmail, required: true },
    { icon: Phone, type: "tel" as const, placeholder: "Phone Number", value: phone, setter: setPhone, required: true },
    { icon: Lock, type: "password" as const, placeholder: "Password", value: password, setter: setPassword, required: true, minLength: 6 },
    { icon: ShieldCheck, type: "password" as const, placeholder: "Confirm Password", value: confirmPassword, setter: setConfirmPassword, required: true, minLength: 6 },
  ];
    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-background overflow-hidden py-12">
      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center px-6">
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-foreground mb-1">Create Candidate Account</h2>
          <p className="text-sm text-muted-foreground">Find and apply to your dream job</p>
